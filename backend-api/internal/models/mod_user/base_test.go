...
var (
	...
	_TestFaker  *gofakeit.Faker = gofakeit.NewFaker(source.NewCrypto(), true)
)
...
func TestMain(m *testing.M) {
	...
	if _DB, _, err = infra.PgConnect(_TestConfig.Sub("postgres"), release); err != nil {
		return
	}
